                                ...
                                @foreach($edit_lonhap as $key => $edit_value)
                                    <form role="form" action="{{URL::to('/update-chitiet-lonhap/lo='.$edit_value->LN_MA.'&sach='.$edit_value->SACH_MA)}}" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" value="{{$edit_value->CTLN_SOLUONG}}" name="CTLN_SOLUONG" class="form-control" id="exampleInputEmail1" placeholder="Số lượng" required="">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Giá</label>
                                            <input type="number" min="0" value="{{$edit_value->CTLN_GIA}}" name="CTLN_GIA" class="form-control" id="exampleInputEmail1" placeholder="Giá" required="">
                                        </div>
